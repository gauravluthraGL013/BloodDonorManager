...
{
    [Activity(Label = "Make Your Account")]
    public class RegisterActivity : AppCompatActivity
    {
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            ...
            if (isNameValid && isPasswordValid)
            {
                ...
                {
                    Toast.MakeText(this, "New User is Created!!!", ToastLength.Long).Show();
                ...
                {
                    Toast.MakeText(this, "User is not Created!!!", ToastLength.Long).Show();
                }
            }
        }
    }
